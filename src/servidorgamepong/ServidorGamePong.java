...
public class ServidorGamePong extends javax.swing.JFrame {
    ...
    private String getDiretorio(){
        String caminho = "";
        try {
            caminho = Processamento.class.getProtectionDomain().getCodeSource().getLocation().toURI().getPath();
    ...
    private void verificaBola(int bolaX, int bolaY, int barraX, int barraY) {
        if(barraX != 13){
            ...
            if(bolaX-velocidadeBola <= (barraX + 25)){
                if(( ((bolaY+77) < barraY+10) || (bolaY > barraY+90) )){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ServidorGamePong.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        //</editor-fold>
